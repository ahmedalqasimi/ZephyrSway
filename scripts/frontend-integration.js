 ...
 * This file demonstrates how to integrate Zephyrsway with a web frontend
 */

// For React/Vue/Angular applications
export class ZephyrswayClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new ZephyrswayClient(provider, contractAddress);
